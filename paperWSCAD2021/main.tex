...
\nextinstitute
  ...
  \email{\{gdsdsilva,jpdmdsilveira, giovani.jahn, gerson.cavalheiro\}@inf.ufpel.edu.br, gold@ime.usp.br}
}
...
Inicialmente partimos com um conjunto de execuções teste afim de entender o simulador e as possibilidades fornecidas por ele. Seguindo as indicações da documentação e observando o tempo comum de trabalho de um usuário do \emph{WebSYHDA}, concluímos que o tempo de execução do simulador decorrente de%mudar isso
